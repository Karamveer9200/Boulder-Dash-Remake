...
//            case 20 -> new Firefly(row, col, followsLeftEdge);
    ...
    public static int [][] initialGrid = {
            ...
            {3, 7, 0, 0, 0, 0, 4, 0, 11, 0, 3},
            {3, 0, 3, 3, 3, 0, 3, 3, 0, 0, 3},
            {3, 0, 3, 0, 0, 0, 0, 3, 0, 7, 3},
            {3, 0, 3, 0, 3, 3, 0, 3, 0, 18, 3},
            {3, 19, 3, 0, 3, 3, 0, 3, 0, 0, 3},
            {3, 0, 3, 0, 0, 20, 0, 3, 0, 0, 3},
            {3, 0, 3, 3, 3, 3, 3, 3, 9, 0, 3},
    ...
    public static int[][] level2Grid = {
            {3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3},
            {3, 7, 0, 0, 0, 19, 0, 0, 20, 11, 3},
            {3, 3, 3, 0, 3, 3, 3, 0, 3, 3, 3},
            {3, 0, 0, 0, 0, 0, 0, 0, 0, 0, 3},
            {3, 0, 3, 4, 0, 3, 3, 3, 3, 0, 3},
            {3, 5, 3, 0, 0, 0, 0, 0, 3, 0, 3},
            {3, 0, 3, 0, 3, 3, 3, 0, 3, 0, 3},
            {3, 7, 3, 0, 3, 9, 3, 0, 3, 0, 3},
            {3, 0, 0, 0, 2, 0, 0, 0, 3, 18, 3},
            {3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3},
    };

    public static int[][] level3Grid = {
            {3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3},
            {3, 0, 0, 19, 0, 3, 7, 0, 20, 0, 11, 3},
            {3, 3, 3, 0, 3, 3, 3, 0, 3, 3, 3, 3},
            {3, 0, 0, 0, 0, 0, 0, 0, 4, 0, 0, 3},
            {3, 0, 3, 3, 3, 3, 0, 3, 3, 3, 0, 3},
            {3, 0, 3, 5, 0, 3, 0, 0, 0, 3, 0, 3},
            {3, 0, 3, 3, 0, 3, 3, 3, 0, 3, 0, 3},
            {3, 0, 0, 0, 0, 0, 0, 3, 0, 0, 0, 3},
            {3, 0, 3, 3, 9, 3, 0, 3, 3, 3, 3, 3},
            {3, 7, 3, 0, 0, 0, 0, 3, 0, 18, 0, 3},
